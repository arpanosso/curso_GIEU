...
tb <-data.frame(Cultivares=c("NK300H","Sordan67H","Pionner988H","Pionner93H","SartV","Total"),
                "Rep1"=c("10,27","9,77","9,86","21,22","20,20",""),
                "Rep2"=c("11,55","9,96","9,59","20,62","20,55",""),
                "Rep3"=c("11,68","11,94","10,43","22,33","22,12",""),
                "Rep4"=c("11,38","10,18","9,99","19,89","20,78",""),
                "Rep5"=c("11,20","10,43","--","21,00","20,90",""),
                "Rep6"=c("11,24","10,49","--","--","20,92",""),
...
## Cálculo das médias e error padrões das médias
