...
|  Contaste |` ` |  Coeficiente 1|Coeficiente 2|Coeficiente 3|
|---|---|---|---|---|
...
a) Se $t_{obs} \in RC$ ou seja, $|t_{obs}| \ge t_{tab}$, o teste é significativo ao nível $\alpha$ de probabilidade considerado. Neste caso, rejeitamos $H_0$ e concluímos que as médias ou grupos de médias testados no contraste diferem significativamente entre si.

b) Se $t_{obs} \not \in RC$ ou seja, $|t_{obs}| < t_{tab}$, o teste é não significativo ao nível $\alpha$ de probabilidade considerado. Neste caso, rejeitamos $H_0$ e concluímos que as médias ou grupos de médias testados no contraste não diferem significativamente entre si.
...
$$
\hat{Y_1} = 2\hat{m_3} - \hat{m_5} - \hat{m_6} = 2 \cdot (24,58) - 28,85 - 28,30 = -7,99\;kg.
$$
