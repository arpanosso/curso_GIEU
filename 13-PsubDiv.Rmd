...
e o esquema da análise de variância do experimento de acordo com o esqeuma fatorial $2 \times 3$, seria o seguinte:
...
|$E_4$|6.2082|5.4999|6.6999|18.4080|
...
**Para efeito de Variedades**: O teste foi significativo ao nível de $1\%$ de probabilidade, indicando que devemos rejeitar a hipótese da nulidade e concluir que asvariedades testadas diferem entre si em relação à produção da cultura da soja.
...
Como neste caso, estamos comparando tratamento principais dentro de tratamento secundários, estão envolvidos a comparação o Resíduo (a) e o Resíduo (b). Então, para aplicarmos o teste F, devemos obter um resíduo médio (variância complexa), dado por:
...
Note, apsera de serem as mesmas médias, do item anterior, a comparação é diferente, então no erro padrão delas, devemos utilizar o $QM_{Resíduo\;Médio}$:
