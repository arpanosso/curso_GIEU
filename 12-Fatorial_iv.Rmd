...
Estes 8 tratamentos devem ser ditribuídos de acosrdo com um delineamento experimental qualquer, como por exemplo, DIC, DBC, etc, e após a análise de variância preliminar, realizada de acordo com o delineamento adotado, devemos desdobrar os graus 7 graus de liberdade de tratamentos da seguinte forma:
...
**Conclusão**: O teste F para tratamentos foi significativo ao nível de $1\%$ de probabilidade, logo, rejeitamos a hipótese da nulidade ($H_0$), e concluímos que os efeitos dos tratamentos diferem entre si em relação à produção da cultura do cafeeiro, com um grau de confiança superior a $99\%$ de probabilidade.
...
|**PxK**|+|+|-|-|-|-|+|+|-50.1|
|**NxPxK**|-|+|+|+|-|-|-|+|-39.1|
|Totais|206,2|214,4|230,5|200,8|231,2|336,0|219,6|308,2||
...
**a) Para efeito de N**: O teste F foi significativo ao nível de $1\%$ de probabilidade, indicando que devemos rejeitar $H_0$, e concluir que os níveis de $N_0$ e $N_1$ possuem efeitos diferentes sobres a produção do cafeeiro.
...
**Para Efeito de N d. K0**: O teste F foi não significativo ao nível de $5\%$ de probabilidade, indicando que não devemos rejeita $H_0$, e concluir que o nível de $N_0$ e $N_1$ não diferem entre si, na ausência de K, em relação à produção do cafeeiro.

**Para Efeito de N d. K1**: O teste F foi significativo ao nível de $1\%$ de probabilidade, indicando que devemos rejeita $H_0$, e concluir que o nível de $N_0$ e $N_1$ diferem entre si, na presença de K, em relação à produção do cafeeiro.
...
**Para Efeito de K d. N0**: O teste F foi não significativo ao nível de $5\%$ de probabilidade, indicando que não devemos rejeita $H_0$, e concluir que o nível de $K_0$ e $K_1$ não diferem entre si, na ausência de N, em relação à produção do cafeeiro.

**Para Efeito de K d. N1**: O teste F foi significativo ao nível de $1\%$ de probabilidade, indicando que devemos rejeita $H_0$, e concluir que o nível de $K_0$ e $K_1$ diferem entre si, na presença de N, em relação à produção do cafeeiro.
