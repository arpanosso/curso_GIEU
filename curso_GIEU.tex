...
\NormalTok{caminho<-}\StringTok{"https://raw.githubusercontent.com/arpanosso/ExpAgr_2020/master/dados/solofungi.txt"}
...
\CommentTok{# Definindo o caminho do banco de dados}
\NormalTok{caminho<-}\StringTok{"https://raw.githubusercontent.com/arpanosso/ExpAgr_2020/master/dados/crotalaria.txt"}
...
\includegraphics{curso_GIEU_files/figure-latex/unnamed-chunk-12-1.pdf}
...
\includegraphics{curso_GIEU_files/figure-latex/unnamed-chunk-12-2.pdf}
\textbf{Analise considerando o delineamento de tratamentos}
...
\NormalTok{caminho<-}\StringTok{"https://raw.githubusercontent.com/arpanosso/ExpAgr_2020/master/dados/sojapsub.txt"}
...
\hypertarget{aplicauxe7uxe3o-em-r---anuxe1lise-de-regressuxe3o}{%
\section{Aplicação em R - Análise de Regressão}\label{aplicauxe7uxe3o-em-r---anuxe1lise-de-regressuxe3o}}
...
\begin{Highlighting}[]
\KeywordTok{require}\NormalTok{(ExpDes.pt)}
\NormalTok{caminho<-}\StringTok{"https://raw.githubusercontent.com/arpanosso/ExpAgr_2020/master/dados/feijaoREG.txt"}
\NormalTok{d<-}\KeywordTok{read.table}\NormalTok{(caminho,}\DataTypeTok{h=}\NormalTok{T)}
